...
PreparedStatement ps=con.prepareStatement("select * from upload where fid=?");
ps.setString(1, fid);
...
<div id="page">
	...
	<div id="content">
	 ...
	 <h2>View  File</h2>
							...
							<p><%=msg%></p>
							<%} %>
							<form name="form" action="filereq.jsp?fid=<%=fid %>" method="post" onsubmit="return validation()">
